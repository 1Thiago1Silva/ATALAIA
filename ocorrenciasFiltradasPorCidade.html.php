...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST['cidade'])) {
    $cidadeBusca = trim($_POST['cidade']);
    $resultado = $ocorrencia->filtrarPorCidade($cidadeBusca);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<div class="container mt-4">
    <h3 class="mb-4">Filtrar por Cidade</h3>
    <div class="btn-group-custom">
        <!-- Formulário de busca por Cidade via POST -->
        <form method="POST" action="ocorrenciasFiltradasPorCidade.html.php" class="d-flex">
            <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Digite a cidade..." value="<?php echo htmlspecialchars($cidadeBusca); ?>" autocomplete="off">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        <?php
            ...
            echo "<p>Nenhuma ocorrência encontrada para a cidade informada.</p>";
        }
    }
    ?>
</div>
...
<!-- Não é necessário autocomplete para cidade -->
</body>
</html>
<?php
